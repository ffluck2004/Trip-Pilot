  ...
  useEffect(() => {
    ...
    if (items.length > 0) {
      ...
      items.forEach((item, index) => {
        ...
        if (item.category === "restaurant") pinColor = "#f97316";
        else if (item.category === "attraction") pinColor = "#3b82f6";
        else if (item.category === "hidden_gem") pinColor = "#8b5cf6";
        else if (item.category === "shopping") pinColor = "#ec4899";
        else if (item.category === "cafe") pinColor = "#a3744e";
        else if (item.category === "street_food") pinColor = "#f59e0b";
        else if (item.category === "beach") pinColor = "#06b6d4";
        else if (item.category === "hotel") pinColor = "#6366f1";
        else if (item.category === "temple" || item.category === "mosque") pinColor = "#b45309";
        else if (item.category === "spa") pinColor = "#d946ef";
        else if (item.category === "mall") pinColor = "#e11d48";
        else if (item.category === "fun_activity") pinColor = "#ef4444";
        else if (item.category === "nightlife") pinColor = "#7c3aed";
        else if (item.category === "rental") pinColor = "#14b8a6";
        else if (item.category === "rest") pinColor = "#10b981";
        else if (item.category === "emergency") pinColor = "#ef4444";
